...
Route::group(['prefix' => 'member', 'middleware' => 'MemberAuth'], function () {
    ...
    // Promotional Banners
    Route::get('/promotional-banners', [MemberDetailController::class, 'promotionalBanners'])->name('member.promotional-banners');
...
Route::get('/temp', function () {
    $check = SingleLegIncome::where([['memberid', 'MW1234567'], ['level', 3]])->first();
    $date = $check->created_at;
   echo number_format($date->diffInDays(now()),0);
});
