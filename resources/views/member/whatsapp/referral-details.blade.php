            ...
            <div class="row g-3 mb-4 text-center">
                ...
                <div class="col-xl-3 col-sm-6 col-12">
                    <div class="card p-3" style="background: rgba(255, 255, 255, 0.05); border: 1px solid rgba(255, 255, 255, 0.12); border-radius: 12px;">
                        <div class="d-flex align-items-center justify-content-between">
                            <div class="text-start">
                                <small class="text-white-50 d-block mb-1" style="font-size: 12px; text-transform: uppercase;">Today's Status</small>
                                <span class="badge {{ $todayStatus === 'Used' ? 'bg-success' : 'bg-warning text-dark' }} font-weight-bold" style="font-size: 13px;">
                                    {{ $todayStatus }}
                                </span>
                            </div>
