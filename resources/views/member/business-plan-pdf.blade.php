                    ...
                    <div class="col-lg-5 col-md-12 text-center text-lg-end">
                        <div class="pdf-quick-stats p-3 rounded-3 text-start d-inline-block w-100"
                            ...
                            <ul class="list-unstyled mb-0 text-white-50" style="font-size: 12px; line-height: 1.8;">
                                ...
                                <li><i class="fas fa-chevron-right text-primary me-2"></i> <strong>Staking
                                        Economics:</strong> Daily returns & lock-in terms.</li>
                                <li><i class="fas fa-chevron-right text-primary me-2"></i> <strong>Affiliate
                                        Compensation:</strong> Direct, level & pool incomes.</li>
