            ...
            <div class="col-md-12">
                ...
                <div class="card" style="overflow:auto">
                    <div class="card-header d-flex justify-content-between align-items-center flex-wrap" style="padding: 12px 20px;">
                        <ul class="nav nav-pills custom-pills" id="withdrawalTabs" role="tablist">
                            <li class="nav-item">
                                <a class="nav-link active font-weight-bold" id="usdt-tab" data-toggle="pill" href="#usdt-panel" role="tab" aria-controls="usdt-panel" aria-selected="true" style="border-radius: 6px; padding: 8px 18px;">
                                    <i class="ik ik-dollar-sign mr-1"></i> {{ __('USDT Requests') }}
                                    <span class="badge badge-light ml-1">{{ count($data) }}</span>
                                </a>
                            </li>
                            <li class="nav-item ml-2">
                                <a class="nav-link font-weight-bold" id="pepe-tab" data-toggle="pill" href="#pepe-panel" role="tab" aria-controls="pepe-panel" aria-selected="false" style="border-radius: 6px; padding: 8px 18px; border: 1px solid #28a745; color: #28a745;">
                                        ...
                                        <tbody>
                                            ...
                                            @forelse (($pepeData ?? []) as $list)
                                                <tr>
                                                    ...
                                                    <td class="px-1">
                                                        <a href="{{ url('hdgteyusjasget/withdrawal/accept') }}/{{ $list['id'] }}"
                                                            onclick="return confirm('Are you sure you want to ACCEPT this PEPE redeem request?')"
                                                            class="btn btn-sm btn-success mx-0">
                                                            <i class="ik ik-check mr-1"></i> Accept
                                                        </a>
                                                    </td>
                                                    <td class="px-1">
                                                        <a href="{{ url('hdgteyusjasget/withdrawal/cancel') }}/{{ $list['id'] }}"
                                                            onclick="return confirm('Are you sure you want to REJECT and refund this PEPE redeem request?')"
                                                            class="btn btn-sm btn-danger mx-0">
                                                            <i class="ik ik-x mr-1"></i> Reject
                                                        </a>
                                                    </td>
                                                </tr>
                                                @php $j++; @endphp
                                            @empty
                                                <tr>
                                                    <td colspan="9" class="text-center py-4 text-muted">
                                                        No pending PEPE token redeem requests found.
                                                    </td>
                                                </tr>
                                            @endforelse
                                        </tbody>
